...
import (
	...
	batchv1 "playground.walrusyu.io/tutourial/api/v1"
)
...
//+kubebuilder:rbac:groups=batch.playground.walrusyu.io,resources=cronjobs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=batch.playground.walrusyu.io,resources=cronjobs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=batch.playground.walrusyu.io,resources=cronjobs/finalizers,verbs=update
...
func (r *CronJobReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// the most recent time of all child jobs
