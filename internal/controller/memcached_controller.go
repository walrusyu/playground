...
import (
	...
	webappv1alpha1 "github.com/walrusyu/playground/api/v1alpha1"
)

const memcachedFinalizer = "webapp.walrusyu.io/finalizer"
...
//+kubebuilder:rbac:groups=webapp.walrusyu.io,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.walrusyu.io,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.walrusyu.io,resources=memcacheds/finalizers,verbs=update
